...
public:
    ...
    public:
        ...
        void reset();
        explicit operator bool() const { return unsubscribe_ != nullptr; }
...
private:
    ...
    std::optional<ScheduledRequest> make_due_poll_request(PollChannel& channel, const SteadyClock::time_point& now);
